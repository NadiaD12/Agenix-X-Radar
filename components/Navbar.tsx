        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button 
              ...
              className={`text-sm font-bold uppercase tracking-widest transition-colors ${currentView === 'os' ? 'text-brand-600' : 'text-slate-500 hover:text-slate-900'}`}
            >
              Agentix OS
            </button>
          </div>
          ...
          <div className="flex items-center space-x-3">
            <button 
              className="hidden sm:inline-flex items-center justify-center px-4 py-2 text-sm font-bold rounded-full text-slate-600 hover:text-slate-900 transition-all"
            >
              Login
            </button>
            <div className="relative group">
              ...
              <button 
                onClick={onOpenDemo}
                className="relative inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-full text-white bg-[#092C4C] hover:bg-[#061d33] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-900 transition-all shadow-lg hover:shadow-xl z-10"
              >
                Start for free
              </button>
            </div>
